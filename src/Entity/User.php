...
class User implements UserInterface
{
    ...
    /**
     * 
     *@Assert\EqualTo(propertyPath="hash", message="Le mot de passe de confirmation ne correspond pas !")
     */
     ...
     * @Assert\Length(min=60, minMessage="Votre description doit faire au moins 60 caractères")
     */
    private $description;
