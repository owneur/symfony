...
class PaginationService {
    ...
    /**
     * Le registry de Doctrine qui nous permet notamment de trouver le repository dont on a besoin
     *
     ...
     */
    public function __construct(EntityManagerInterface $registry, Environment $twig, RequestStack $request, string $templatePath) {
